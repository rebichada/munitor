...
// el byte puede contener valores de -128 a 127
    ...
    try {
		...
		GanadoDatos gd1 = new GanadoDatos(g1,40d,1,1,200d,true,new Date());
		GanadoDatos gd2 = new GanadoDatos(g2,30d,1,1,170d,true,new Date());
		GanadoDatos gd3 = new GanadoDatos(g3,53d,1,1,220d,true,new Date());
		GanadoDatos gd4 = new GanadoDatos(g4,35d,1,1,210d,true,new Date());
		GanadoDatos gd5 = new GanadoDatos(g5,32d,1,1,205d,true,new Date());
		GanadoDatos gd6 = new GanadoDatos(g6,21d,1,1,203d,true,new Date());
		GanadoDatos gd7 = new GanadoDatos(g7,22d,1,1,202d,true,new Date());
		GanadoDatos gd8 = new GanadoDatos(g8,50d,1,1,190d,true,new Date());
		GanadoDatos gd9 = new GanadoDatos(g9,60d,1,1,201d,true,new Date());
		GanadoDatos gd10 = new GanadoDatos(g10,30d,1,1,250d,true,new Date());
		GanadoDatos gd11 = new GanadoDatos(g11,25d,1,1,270d,true,new Date());
		GanadoDatos gd12 = new GanadoDatos(g12,27d,1,1,255d,true,new Date());
		GanadoDatos gd13 = new GanadoDatos(g13,26d,1,1,235d,true,new Date());
		GanadoDatos gd14 = new GanadoDatos(g14,29d,1,1,262d,true,new Date());
		GanadoDatos gd15 = new GanadoDatos(g15,32d,1,1,272d,true,new Date());
		GanadoDatos gd16 = new GanadoDatos(g16,32d,1,1,281d,true,new Date());
		GanadoDatos gd17 = new GanadoDatos(g17,33d,1,1,291d,true,new Date());
		GanadoDatos gd18 = new GanadoDatos(g18,35d,1,1,202d,true,new Date());
		GanadoDatos gd19 = new GanadoDatos(g19,41d,1,1,295d,true,new Date());
		GanadoDatos gd20 = new GanadoDatos(g20,19d,1,1,235d,true,new Date());
		ganadoDatos.add(gd1);
		ganadoDatos.add(gd2);
		ganadoDatos.add(gd3);
		ganadoDatos.add(gd4);
